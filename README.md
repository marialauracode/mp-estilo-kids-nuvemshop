## 🛍️ MP Estilo Kids – Loja Infantil (Nuvemshop)
...
- Organização das categorias e menus
- Configuração visual das páginas
- Cadastro de produtos
- Criação de banners e elementos visuais
...
- Estruturação de vitrines e páginas de venda

---

## 📸 Capturas de Tela

As imagens da loja estão disponíveis na pasta `/screenshots`.
...
Registrar e demonstrar minha habilidade em criar e gerenciar **e-commerces completos**, mesmo sem desenvolvimento direto em código, reforçando minha experiência real em projetos para clientes.
